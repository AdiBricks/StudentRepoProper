...
Creative Commons Zero v1.0 Universal: provides a way for creators to waive all their copyright and related rights, allows for the free use of the work in the public domain dedication; anyone can use the work without restrictions.
Open Source MIT License: Open-source license allowing freedom to use with minimal restrictions. used in projects like jQuery and Ruby on Rails.
Open Source GPL License: Requires derivative works to also be open source, promoting the freedom to share and modify Common in the Linux operating system and many other open-source software projects, GNU General Public License (GPL) is a example.
...
Qualcomm: leverages patents alongside open source, but conflicts can arise due to GPL terms limiting revenue generation,so may prefer royalty payments for code usage over the restrictions of GPL.
Red Hat: Works with strictly to open-source licenses to avoid legal consequences and reputational damage. It faces potential patent infringement claims, and ensures compliance with data protection laws to avoid legal and regulatory issues.
...
Businesses might opt for royalty payments to protect revenue streams when dealing with open-source projects. Proper licensing promotes ethical use of intellectual property and encourages fair innovation. Disney and many other companies promote this, leaving out lots of work for people to grow on. 
